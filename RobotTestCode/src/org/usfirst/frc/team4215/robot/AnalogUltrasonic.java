...
public class AnalogUltrasonic extends SensorBase {
    ...
    AnalogInput channel;
    //constructor
    public AnalogUltrasonic(int _channel) {
    ...
    //constructor
    public AnalogUltrasonic(int _channel, boolean _use_units, double _min_voltage,
